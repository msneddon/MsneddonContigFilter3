...
from MsneddonContigFilter3.MsneddonContigFilter3Impl import MsneddonContigFilter3
from MsneddonContigFilter3.MsneddonContigFilter3Server import MethodContext

from AssemblyUtil.AssemblyUtilClient import AssemblyUtil

class MsneddonContigFilter3Test(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('MsneddonContigFilter3'):
            cls.cfg[nameval[0]] = nameval[1]
        cls.wsURL = cls.cfg['workspace-url']
        cls.wsClient = workspaceService(cls.wsURL)
        cls.serviceImpl = MsneddonContigFilter3(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_MsneddonContigFilter3_" + str(suffix)
